...
![BGP、OSPFを使用したWAN回線冗長シミュレーション](https://raw.githubusercontent.com/Urapy/zenn-qiita-contents/main/images/gns3-intro-simulations/01-wan-redundancy.jpg)

_写真1 BGP、OSPFを使用したWAN回線冗長シミュレーション_

![ロードバランサー、DNS、webサーバを使った総合シミュレーション](https://raw.githubusercontent.com/Urapy/zenn-qiita-contents/main/images/gns3-intro-simulations/02-lb-dns-web.jpg)

_写真2 ロードバランサー、DNS、webサーバを使った総合シミュレーション_
